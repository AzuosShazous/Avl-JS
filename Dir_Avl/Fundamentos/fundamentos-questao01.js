...
let horas = String(data_atual.getHours()).padStart(2, '0')
let minutos = String(data_atual.getMinutes()).padStart(2, '0')
let segundos = String(data_atual.getSeconds()).padStart(2, '0')
